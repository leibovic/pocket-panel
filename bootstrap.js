...
function startup(aData, aReason) {
  ...
  Home.panels.register("test1@margaretleibovic.com", function() {
    return {
      title: "Test Panel",
      views: [{
        type: Home.panels.View.LIST,
        dataset: "test.dataset@margaretleibovic.com"
      }]
    };
  });
  ...
  switch(aReason) {
    case ADDON_INSTALL:
      ...
      Task.spawn(function() {
        let storage = HomeProvider.getStorage("test.dataset@margaretleibovic.com");
        yield storage.save([{
          title: "Item 1",
